// ── src/pages/AccountInactivePage.jsx ─────────────────────────────
// Full-screen gate shown when the user's active CDS is deactivated.
// Uses the login page's dark visual style.
import { useState, useEffect, useCallback, memo } from "react";
import { useIsMobile, useTheme } from "../components/ui";
import { sbGetSuperAdminContacts } from "../lib/supabase";
...
// ── Main page ────────────────────────────────────────────────────
export default function AccountInactivePage({ cdsNumber, onSignOut }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            fontWeight: 800, fontSize: isMobile ? 18 : 17,
