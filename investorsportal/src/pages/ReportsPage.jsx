...
import { sbGetPortfolioAsAt, sbGetTransactions, sbGetFifoSellDetails } from "../lib/supabase";
import { generatePortfolioStatementPDFv2, generatePortfolioStatementExcelv2, generateTransactionHistoryPDF, generateTransactionHistoryExcel, generateGainLossPDF, generateGainLossExcel } from "../lib/reports";
...
const CAPITAL_MARKET_REPORTS = [
  ...
  { id: "dividend_income",     title: "Dividend Income",     desc: "Dividends received, withholding tax and net income", icon: "dollar",   ready: false },
  { id: "fee_summary",         title: "Fee Summary",         desc: "Broker and regulatory fees breakdown", icon: "percent",    ready: false },
