    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <img src={logo} alt="Investors Portal" style={{ width: 56, height: 56, borderRadius: 14, objectFit: "cover", marginBottom: 12, boxShadow: "0 6px 20px rgba(0,0,0,0.2)" }} />
          <div style={{ fontWeight: 800, fontSize: 20, color: C.text, marginBottom: 3 }}>Investors Portal</div>
          <div style={{ fontWeight: 600, fontSize: 13, color: C.gray400 }}>Complete Your Profile</div>
          {/* Email chip */}
          <div style={{ marginTop: 10, display: "inline-flex", alignItems: "center", gap: 7, background: C.gray100, border: `1px solid ${C.gray200}`, borderRadius: 10, padding: "7px 14px" }}>
            <span style={{ fontSize: 14 }}>📧</span>
            <span style={{ fontSize: 13, color: C.navy, fontWeight: 700, letterSpacing: "0.01em" }}>{email}</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 16 }}>
            <label style={{ fontSize: 12, fontWeight: 700, color: C.text, display: "block", marginBottom: 7, letterSpacing: "0.01em" }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 7 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: C.text, letterSpacing: "0.01em" }}>
                CDS Number <span style={{ color: C.red }}>*</span>
              </label>
              {cdsLocked && (
                <span style={{ fontSize: 11, color: C.green, fontWeight: 700, background: "#f0fdf4", border: `1px solid #bbf7d0`, borderRadius: 7, padding: "2px 9px", display: "flex", alignItems: "center", gap: 4 }}>
                  🔒 Pre-assigned
                </span>
              )}
            </div>
            ...
            />
            <div style={{ fontSize: 12, color: C.gray400, marginTop: 5, lineHeight: 1.5 }}>
              {cdsLocked
          ...
          <button type="submit" disabled={saving || cancelling} style={{
            ...
            {saving
              ? <><div style={{ width: 15, height: 15, border: "2px solid rgba(255,255,255,0.3)", borderTop: "2px solid #fff", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />Saving...</>
              : "Continue to Portal →"}
          </button>
          ...
          <div style={{ fontSize: 12, color: C.gray400, textAlign: "center", marginTop: 12, lineHeight: 1.5 }}>
            These details can be updated later in <strong style={{ color: C.navy }}>My Profile</strong>
          </div>
        </form>

        {/* Footer */}
        <div style={{ marginTop: 22, paddingTop: 16, borderTop: `1px solid ${C.gray100}` }}>
