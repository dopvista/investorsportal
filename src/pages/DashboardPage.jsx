          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 10 }}>
              ...
              <MobileStatPill
                ...
                accent="#f59e0b"   // keep orange for pending (no equivalent in theme)
                navigates
              />
            </div>
          ...
          <>
            ...
            >
              ...
              <StatCard
                ...
                accent="#f59e0b"   // keep orange for pending
                accentBg="#f59e0b"
                onClick={onNavTransactions}
                navigates
                loading={loading}
            ...
            {expanded === "users" && (
              <ExpandPanel title={`👥 ${cds ? `CDS ${cds}` : "All"} — Members (${cdsUsers.length})`} accentColor={C.navy} onClose={onCloseExpand}>
