...
const DEFAULT_SLIDES = [
  {
    ...
    color: C.navy,
    image:
      "https://images.unsplash.com/photo-1611974717482-480928224732?auto=format&fit=crop&q=80",
  },
  {
    id: 2,
    title: "Secure Investing",
    sub: "Your assets are protected with us.",
    color: "#064e3b",
    image:
  ...
  },
  {
    ...
    color: "#78350f",
    image:
      "https://images.unsplash.com/photo-1551288049-bbda38a5f9a2?auto=format&fit=crop&q=80",
  },
];

export default function LoginPage({ onLogin, loginSettings }) {
  const ADVERTS = useMemo(
    () => (loginSettings?.slides || DEFAULT_SLIDES).map((s, i) => ({ ...s, id: i + 1 })),
    [loginSettings]
  );
      ...
      <div style={{ width: "100%", maxWidth: isMobile ? "none" : 312, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: isMobile ? 32 : 20 }}>
          ...
          <div
            style={{
              fontSize: isMobile ? 14 : 13,
              color: isMobile ? "rgba(255,255,255,0.55)" : C.gray400,
              marginTop: 4,
            }}
          >
